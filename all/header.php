...
function user_id() {
        ...
        echo '<a href="http://localhost/eshop/user/cart_view.php"><span style="font-size:15px;">',$cart_product.'</span></a>'; 
        }  
          }
...
<!--                    <li class="nav-item">
                        <a class="nav-link" href="/eshop/user/all_product.php">All Product</a>
                    </li>-->
<!--                    <li class="nav-item">
         ...
         <?php user_id();?></i>
                   ...
                   <form class="d-flex" name="searchbox" action="/eshop/user/searchresult.php">
